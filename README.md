...
## Firmware (ESP32) — data straight to your phone over WiFi
...
Open the repo folder directly in PlatformIO — `platformio.ini` is at the root.
...
## geotag — where did I capture that signal?
